...
def loginpage():
    ...
    if request.method == 'POST' :
        ...
        if account:
            ...
            sendmail(account['EMAIL'],'Plasma donor Application login','You are Successfully logged in!')
...
def register():
    ...
    if request.method == 'POST' :
        ...
        if account:
            ...
            sendmail(email,'Plasma donor Application Registration','You are Successfully Registered {}!'.format(username))
